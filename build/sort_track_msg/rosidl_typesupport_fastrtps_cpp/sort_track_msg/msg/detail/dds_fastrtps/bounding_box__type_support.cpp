...
#include "sort_track_msg/msg/detail/bounding_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const sort_track_msg::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sort_track_msg::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  return &sort_track_msg::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
