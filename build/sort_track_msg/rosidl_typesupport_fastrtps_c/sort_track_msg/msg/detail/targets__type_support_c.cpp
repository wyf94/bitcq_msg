...
#include "sort_track_msg/msg/detail/targets__rosidl_typesupport_fastrtps_c.h"
...
#include "sort_track_msg/msg/detail/target__functions.h"  // data
...
using _Targets__ros_msg_type = sort_track_msg__msg__Targets;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: data
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, sort_track_msg, msg, Target
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      sort_track_msg__msg__Target__Sequence__fini(&ros_message->data);
    }
...
size_t get_serialized_size_sort_track_msg__msg__Targets(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Targets__ros_msg_type * ros_message = static_cast<const _Targets__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_sort_track_msg__msg__Target(
...
static uint32_t _Targets__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sort_track_msg__msg__Targets(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sort_track_msg
size_t max_serialized_size_sort_track_msg__msg__Targets(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_sort_track_msg__msg__Target(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_sort_track_msg__msg__Targets(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sort_track_msg, msg, Targets)() {
