...
class Metaclass_Tracks(type):
    """Metaclass of message 'Tracks'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sort_track_msg.msg.Tracks')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__tracks
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__tracks
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__tracks
            ...
            from sort_track_msg.msg import BoundingBox
...
class Tracks(metaclass=Metaclass_Tracks):
    ...
    _fields_and_field_types = {
        ...
        'bounding_boxes': 'sequence<sort_track_msg/BoundingBox>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['sort_track_msg', 'msg'], 'BoundingBox')),  # noqa: E501
    )
