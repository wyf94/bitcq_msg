...
class Metaclass_Targets(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from sort_track_msg.msg import Target
...
class Targets(metaclass=Metaclass_Targets):
    ...
    _fields_and_field_types = {
        ...
        'data': 'sequence<sort_track_msg/Target>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['sort_track_msg', 'msg'], 'Target')),  # noqa: E501
    )
